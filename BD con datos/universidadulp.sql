...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-09-2023 a las 00:33:33
...
(8, 42301733, 'Gonzáles', 'Marco', '1997-11-05', 1),
(9, 42200748, 'Zannetti', 'Emmanuel', '2000-05-12', 1);
...
(79, 'Derecho Constitucional', 1, 1),
(215, 'Física', 1, 1),
(568, 'Analisis Matemático I', 1, 1),
(663, 'Nutrición y Regulación', 3, 1);
...
--
ALTER TABLE `materia`
  MODIFY `idMateria` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=664;
